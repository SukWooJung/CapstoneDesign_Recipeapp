...
class fridgeFragment : Fragment() {
    ...
    var selectionList2 = ArrayList<Long>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Add Swipe
        val swipe = object: RefrigeratorSwiperHelper(activity?.applicationContext, recycler_test, 200){
                    ...
                    RefrigeratorDeleteButton(
                        ...
                        object : MyButtonClickListener {
                            override fun onclick(pos: Int) {
                                ...
                                db.ingredientDAO().deactivate(tempName)     //삭제버튼 누르면 activation이 0으로 바뀌어야함. db에 잘 반영됨
